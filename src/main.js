...
function c1CompCurr() {
    ...
    var button = document.getElementById("c1_call");
...
function c2CompCurr() {
    ...
    var button = document.getElementById("c2_call");
    if (status != "Offline" && status != "Available") {
        c2_indicator.style.background = "green";
        button.disabled = false;
    }
...
function c3CompCurr() {
    ...
    var button = document.getElementById("c3_call");
    if (status != "Offline" && status != "Available") {
        c3_indicator.style.background = "green";
        button.disabled = false;
    }
...
function c4CompCurr() {
    ...
    var button = document.getElementById("c4_call");
    if (status != "Offline" && status != "Available") {
        c4_indicator.style.background = "green";
        button.disabled = false;
    }
